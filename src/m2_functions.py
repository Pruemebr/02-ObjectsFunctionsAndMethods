...
def turtle4():
    ...
    tim.pen = rg.Pen('orange', 20)
    tim.paint_bucket = rg.PaintBucket('green')
    tim.speed = 20

    tim.backward(300)
    tim.begin_fill()
    tim.draw_regular_polygon(3,50)
    tim.end_fill()


def turtle5():
    reed = rg.SimpleTurtle('triangle')
    reed.pen = rg.Pen('blue', 30)
    reed.paint_bucket = rg.PaintBucket('red')
    reed.speed = 50

    reed.begin_fill()
    reed.draw_regular_polygon(6,50)
    reed.end_fill()
