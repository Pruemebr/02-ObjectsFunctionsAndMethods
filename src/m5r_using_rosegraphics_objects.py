...
#              It goes to the right of the origin
#
#        -- In what direction on the screen does the positive Y-axis point?
#              It points downward from the top left corner.
#
...
#                    circle._get_options_for_drawing()
#                   circle._initialize_options()
...
#                   It draws everything in attached to the RoseWindow
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            At the end of use of the window so that the window can be closed
#
